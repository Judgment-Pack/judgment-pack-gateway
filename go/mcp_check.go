...
// "What it is"): it must not be root, hold no capability, belong to no
// supplementary group, and be denied the seed, every credentials file and
// the store. A path that does not exist, or any answer other than denial,
// is refused too, since it says nothing.
